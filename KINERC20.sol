...
contract KIN is ERC20Permit, Ownable {
    ...
    constructor() ERC20("KIN", "KIN", 9) ERC20Permit() {
    ...
    /**
        @notice increases KIN supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess KIN
